...
export const marketUniverse: readonly MarketInstrument[] = [
  ...
  { id:"binance:BTCUSDT", symbol:"BTC/USDT", displayName:"Bitcoin", market:"crypto", exchange:"BINANCE", currency:"USDT", tickSize:0.01, lotSize:0.00001, enabled:true, providerRequired:false, sector:"Crypto" },
  { id:"binance:ETHUSDT", symbol:"ETH/USDT", displayName:"Ethereum", market:"crypto", exchange:"BINANCE", currency:"USDT", tickSize:0.01, lotSize:0.0001, enabled:true, providerRequired:false, sector:"Crypto" },
  { id:"binance:SOLUSDT", symbol:"SOL/USDT", displayName:"Solana", market:"crypto", exchange:"BINANCE", currency:"USDT", tickSize:0.001, lotSize:0.001, enabled:true, providerRequired:false, sector:"Crypto" },
