...
export interface WilliamsROptions { period?: number; }
/** Williams percent R. Deterministic educational analytics; not investment advice. */
export function calculateWilliamsR(series: OhlcvSeries, options: WilliamsROptions = {}): IndicatorResult {
 ...
 return {name:"williams-r",values,metadata:{period,description:"Williams percent R"}};
}
