...
export interface AdxOptions { period?: number; }
/** Average directional index. Deterministic educational analytics; not investment advice. */
export function calculateAdx(series: OhlcvSeries, options: AdxOptions = {}): IndicatorResult {
 ...
 return {name:"adx",values,metadata:{period,description:"Average directional index"}};
}
