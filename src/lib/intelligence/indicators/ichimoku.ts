...
export interface IchimokuOptions { period?: number; }
/** Ichimoku cloud. Deterministic educational analytics; not investment advice. */
export function calculateIchimoku(series: OhlcvSeries, options: IchimokuOptions = {}): IndicatorResult {
 ...
 return {name:"ichimoku",values,metadata:{period,description:"Ichimoku cloud"}};
}
