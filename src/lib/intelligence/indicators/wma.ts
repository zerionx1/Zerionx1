...
export interface WmaOptions { period?: number; }
/** Weighted moving average. Deterministic educational analytics; not investment advice. */
export function calculateWma(series: OhlcvSeries, options: WmaOptions = {}): IndicatorResult {
 ...
 return {name:"wma",values,metadata:{period,description:"Weighted moving average"}};
}
