...
export interface BollingerBandsOptions { period?: number; }
/** Bollinger bands. Deterministic educational analytics; not investment advice. */
export function calculateBollingerBands(series: OhlcvSeries, options: BollingerBandsOptions = {}): IndicatorResult {
 ...
 return {name:"bollinger-bands",values,metadata:{period,description:"Bollinger bands"}};
}
