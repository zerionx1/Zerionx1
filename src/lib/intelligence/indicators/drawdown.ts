...
export interface DrawdownOptions { period?: number; }
/** Rolling drawdown. Deterministic educational analytics; not investment advice. */
export function calculateDrawdown(series: OhlcvSeries, options: DrawdownOptions = {}): IndicatorResult {
 ...
 return {name:"drawdown",values,metadata:{period,description:"Rolling drawdown"}};
}
