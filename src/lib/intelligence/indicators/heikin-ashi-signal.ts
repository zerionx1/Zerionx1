...
export interface HeikinAshiSignalOptions { period?: number; }
/** Heikin-Ashi trend signal. Deterministic educational analytics; not investment advice. */
export function calculateHeikinAshiSignal(series: OhlcvSeries, options: HeikinAshiSignalOptions = {}): IndicatorResult {
 ...
 return {name:"heikin-ashi-signal",values,metadata:{period,description:"Heikin-Ashi trend signal"}};
}
