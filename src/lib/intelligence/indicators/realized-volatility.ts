...
export interface RealizedVolatilityOptions { period?: number; }
/** Realized volatility. Deterministic educational analytics; not investment advice. */
export function calculateRealizedVolatility(series: OhlcvSeries, options: RealizedVolatilityOptions = {}): IndicatorResult {
 ...
 return {name:"realized-volatility",values,metadata:{period,description:"Realized volatility"}};
}
