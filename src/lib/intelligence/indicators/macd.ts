...
export interface MacdOptions { period?: number; }
/** Moving average convergence divergence. Deterministic educational analytics; not investment advice. */
export function calculateMacd(series: OhlcvSeries, options: MacdOptions = {}): IndicatorResult {
 ...
 return {name:"macd",values,metadata:{period,description:"Moving average convergence divergence"}};
}
