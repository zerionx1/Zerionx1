...
export interface MfiOptions { period?: number; }
/** Money flow index. Deterministic educational analytics; not investment advice. */
export function calculateMfi(series: OhlcvSeries, options: MfiOptions = {}): IndicatorResult {
 ...
 return {name:"mfi",values,metadata:{period,description:"Money flow index"}};
}
