...
export interface EmaOptions { period?: number; }
/** Exponential moving average. Deterministic educational analytics; not investment advice. */
export function calculateEma(series: OhlcvSeries, options: EmaOptions = {}): IndicatorResult {
 ...
 return {name:"ema",values,metadata:{period,description:"Exponential moving average"}};
}
