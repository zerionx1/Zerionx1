...
export interface ObvOptions { period?: number; }
/** On-balance volume. Deterministic educational analytics; not investment advice. */
export function calculateObv(series: OhlcvSeries, options: ObvOptions = {}): IndicatorResult {
 ...
 return {name:"obv",values,metadata:{period,description:"On-balance volume"}};
}
