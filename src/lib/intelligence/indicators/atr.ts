...
export interface AtrOptions { period?: number; }
/** Average true range. Deterministic educational analytics; not investment advice. */
export function calculateAtr(series: OhlcvSeries, options: AtrOptions = {}): IndicatorResult {
 ...
 return {name:"atr",values,metadata:{period,description:"Average true range"}};
}
