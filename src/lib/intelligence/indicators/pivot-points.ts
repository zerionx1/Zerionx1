...
export interface PivotPointsOptions { period?: number; }
/** Classic pivot points. Deterministic educational analytics; not investment advice. */
export function calculatePivotPoints(series: OhlcvSeries, options: PivotPointsOptions = {}): IndicatorResult {
 ...
 return {name:"pivot-points",values,metadata:{period,description:"Classic pivot points"}};
}
