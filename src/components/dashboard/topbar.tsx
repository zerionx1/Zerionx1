...
export function Topbar(){
  ...
  return <header className="x1-topbar hidden lg:flex">
    <div className="relative max-w-xl flex-1">
      <Search className="absolute left-4 top-3.5 h-4 w-4 text-[#2F2A25]"/>
