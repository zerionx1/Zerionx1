...
export function StrategyMarketplace() {
  ...
  return <div className="space-y-6"><section className="panel"><p className="eyebrow">READY STRATEGIES</p><h2 className="mt-2 text-3xl font-semibold">Install ready-to-use strategies</h2><p className="mt-3 text-[#2F2A25]">Ready strategies are preconfigured. Install them, then Enable / Disable / Delete from runtime. No Customize action is shown in this flow.</p></section>
