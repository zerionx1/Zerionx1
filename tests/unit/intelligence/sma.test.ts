import { describe,it,expect } from "vitest";import { calculateSma } from "@/lib/intelligence/indicators/sma";
...
describe("sma",()=>{it("returns aligned output",()=>expect(calculateSma(series).values).toHaveLength(series.close.length));});
