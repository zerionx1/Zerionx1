import { describe,it,expect } from "vitest";import { calculateEma } from "@/lib/intelligence/indicators/ema";
...
describe("ema",()=>{it("returns aligned output",()=>expect(calculateEma(series).values).toHaveLength(series.close.length));});
