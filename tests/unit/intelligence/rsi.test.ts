import { describe,it,expect } from "vitest";import { calculateRsi } from "@/lib/intelligence/indicators/rsi";
...
describe("rsi",()=>{it("returns aligned output",()=>expect(calculateRsi(series).values).toHaveLength(series.close.length));});
