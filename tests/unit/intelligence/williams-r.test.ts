import { describe,it,expect } from "vitest";import { calculateWilliamsR } from "@/lib/intelligence/indicators/williams-r";
...
describe("williams-r",()=>{it("returns aligned output",()=>expect(calculateWilliamsR(series).values).toHaveLength(series.close.length));});
